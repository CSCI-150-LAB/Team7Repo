...
1. FR1: User Registration
    ...
    - Dependencies: None
2. FR2: Login
    - Description: The user will type their email and password and click the login button and the database will verify that it matches and connect the user to their information.
    - Reasoning: In order for the user to access their account after registering.
    - Dependencies: FR1
