<main class="main main-home">
    <div class="container pt-5">
        ...
        <div class="row mb-4">
            ...
            <div class="col-md-4 text-white bg-blue p-4">
                <h3>About</h3>
                <p class="mb-0">The idea of this project came from a couple of students who have both taught children and taken classes from professors.  They realized that having real-time feedback about how well the students are comprehending that can be anonoymous or not would help both students and teachers be more effective.</p>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-sm-6 col-lg-3 my-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        <h5 class="card-title text-center">Visual</h5>
            ...
            <div class="col-sm-6 col-lg-3 my-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        <h5 class="card-title text-center">Auditory </h5>
            ...
            <div class="col-sm-6 col-lg-3 my-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        <h5 class="card-title text-center">Reading/Writing </h5>
            ...
            <div class="col-sm-6 col-lg-3 my-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        <h5 class="card-title text-center">Kinesthetic</h5>
