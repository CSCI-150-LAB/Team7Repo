    ...
    <div style="padding-top: 60px">
        <div class="row" style="margin:auto">
            ...
            <div class="col-sm-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        <h5 class="card-title" style="text-align: center">Reports</h5>
                </div>
            </div>
            </div>
            <div class="col-sm-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        <h5 class="card-title" style="text-align: center">Company Info</h5>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row" style="margin:auto">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <h5 class="card-title" style="text-align: center">Security</h5>
                </div>
            </div>
        </div>
    </div>
