            ...
            for ($counter = count($reviews)-1; $counter >= 0; $counter--) { ?> 
                <div class = "card"> 
                    <div class = "card-body"> 
                        ...
                        <br>
                        <br>
                        <button type="button" class="btn btn-outline-danger " style ="text-align:right"><a href="<?php echo $this->baseUrl("Admin/DeleteFeedback/{$reviews[$counter]->ratingId}") ?>"> Delete </a></button>
                    </div>
                </div>
                <br>
        <?php } 
