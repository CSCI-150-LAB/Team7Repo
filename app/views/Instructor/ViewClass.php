...
<!--Class Menu-->
	<div class = "col-sm-3">
		<div class="accordion" id="accordionExample">
			...
			<!-- Course Materials -->
			<div class = "card">
				<div class="card-header"> Course Materials <a class="btn btn-danger float-right" href='<?php echo $this->baseUrl("/Instructor/CourseMaterials/{$class->classid}") ?>' style="color: #ffffff;"> <i class="fas fa-chevron-right"></i></a> </div>
			</div>
			<!-- Add Student/TA -->
			<div class="card">
