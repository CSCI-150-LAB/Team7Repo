...
<a class = "btn btn-secondary float-right" style="color: #ffffff;" href ='<?php echo $this->baseUrl("/Feedback/PublishedFeedback") ?>'>View feedback sessions</a><br> <!--This will get the query-->
